...
public class Runner {
	...
	/**
	 * Следит за выполненией рекурсии в скриптах
	...
	private ExecutionResponse scriptMode(String argument) {
		console.println("Запуск скрипта: " + argument);
	 ...
	 * @return Код завершения.
	 */
	private ExecutionResponse launchCommand(String[] userCommand) throws Input.InputStop {
